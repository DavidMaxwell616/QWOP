...
function createBodiesAndJoints() {
  ...
  rightElbow = game.physics.box2d.revoluteJoint(upperRightArm, lowerRightArm, 18, 40, 10, -20, 0, motorTorque, false, elbowLimits[0], elbowLimits[1], true);
  ...
  rightAnkle = game.physics.box2d.revoluteJoint(rightLeg, rightFoot, 0, 40, -15, 0, 0, motorTorque, true, ankleLimits[0], ankleLimits[1], true);
  ...
  leftAnkle = game.physics.box2d.revoluteJoint(leftLeg, leftFoot, 0, 40, -15, 0, 0, motorTorque, true, ankleLimits[0], ankleLimits[1], true);
  leftElbow = game.physics.box2d.revoluteJoint(upperLeftArm, lowerLeftArm, 18, 40, 10, -20, 0, motorTorque, false, elbowLimits[0], elbowLimits[1], true);
...
function update() {
  ...
  totalDistTraveled = leftFoot.x - originX<0 ? 0: body.x - originX;
